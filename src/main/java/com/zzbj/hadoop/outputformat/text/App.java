...
public class App {
	...
	public static void main(String[] args) throws Exception {
		...
		TextOutputFormat.setCompressOutput(job, true);// 设置压缩
//		TextOutputFormat.setOutputCompressorClass(job, GzipCodec.class); //设置编解码器
		TextOutputFormat.setOutputCompressorClass(job, SnappyCodec.class); //设置编解码器
